...
if(product){
    ...
    for(let i=0;i<successfulOrder.length;i++){
       if(successfulOrder[i].id== product.order_id){
    ...
    res.status(406).json({message:'You can add a review only when the item you ordered was approved'})
}
 }
