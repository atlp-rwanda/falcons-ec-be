...
const sendVerifyEmail = (token) => {
  const message = `Hello, Thank you for registering on our site. Please click on this link to verify your email address: <a href="${clientURL}/api/v1/users/verify-account/${token}">Verify Account</a>. If you did not register for an account with Falcons Project, please ignore this email.`;
  return message;
};
